...
class CreatingBooksTestTest < ActionDispatch::IntegrationTest
  test 'creating new books' do
    post '/books', params: { book: { title: 'Pragmatic Programmer', rating: 5, author: 'Dave Thomas', genre_id: 1, review: 'Excellent book for any programmer.', amazon_id: '13123' } }.to_json,
